...
RUNS = Path(r"c:/Users/drash/OneDrive/Desktop/CSFL-simulator/runs/runs_scope_revised")
...
def load():
    ...
    for mf in glob.glob(str(RUNS / "*" / "*" / "manifest.json")):
        ...
        # Older orchestrator versions wrote no status key at all. Filtering on
        # status == "complete" silently drops 8 of the 17 families, which is
        # what made the figures disagree with the verified tables.
