...
def main() -> None:
    ...
    # Hand-measured credits for float edits the counters cannot see: narrowing
    # the related-work table from five columns to four removes about a third of
    # its rows' wrapped height.
    manual = int(os.environ.get("MANUAL_CREDIT", "-125"))
    added = d_words + d_eq * 30 + d_tab * 110 + d_fig * 170 + manual
