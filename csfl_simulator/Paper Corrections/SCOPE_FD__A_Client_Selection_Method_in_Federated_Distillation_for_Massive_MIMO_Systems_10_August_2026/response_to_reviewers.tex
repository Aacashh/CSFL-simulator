...
For scale, we now report client pools of $N \in \{47, 50, 53, 100, 200\}$ at participation ratios of five, ten and twenty percent. The fairness result strengthens as the pool grows: at $N = 200$ with $K = 10$ the proposed selector reaches $51.27\%$ accuracy with a Gini of $0.00\%$, while uniform random reaches $48.84\%$ with $24.16\%$.
