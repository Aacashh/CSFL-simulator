...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--profile",
        choices=("quick", "pilot", "pilot_lambda", "core", "energy", "scaling", "full", "cifar100", "cifar100_v2", "maml_v2", "maml_v2_cpu", "audio_fsdd", "review_hardening", "arch_ablation", "lambda_anchor", "convergence", "report_card", "report_card_main"),
        default="core",
    )
